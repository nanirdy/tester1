...
<body onload="load();">
       ...
       <h1>UsersList</h1>
        ...
        <a href="/SpringMVC17/gatecheck/page">MOM</a></br></br>
		
		<select id="usermesser" name="usermesser" placeholder="Select user..." onchange="myFunction()">
			
		</select>
		
		<a href="grppage">Group Chat</a></br></br>
